...
enum mode {modeCarousel, modeFade, modeRain, modeSnake, modeSparkle};
...
Adafruit_NeoPixel pixelStrips[8] = {strip_1, strip_2, strip_3, strip_4, strip_5, strip_7, strip_6, strip_8};
